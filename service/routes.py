...
def list_products():
    ...
    """
    app.logger.info("Request to get list of products.")
...
def get_products(product_id):
    ...
    app.logger.info(f"Product with id {product_id} found: {product.name}.")
...
def update_products(product_id):
    ...
    product.update()
    app.logger.info(f"Product with id {product_id} updated: {product.name}.")
    return product.serialize(), status.HTTP_200_OK
...
def delete_products(product_id):
    ...
    app.logger.info(f"Product with id {product_id} deleted.")
